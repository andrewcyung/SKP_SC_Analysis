...
for j=1:14
    ...
    for i=1:5 %iterate MRI slice position
        ...
        load([src_path 'CPMG_T2dist']); %load imT2dist
        load([src_path 'CPMG_IntegLim_CVvarlim']); %load imIntegLim_CVvarlim
        save([src_path 'CPMG_upstreamData_CVvarlim.mat'],'imT2dist','imIntegLim_CVvarlim');
    end
end
