...
function h_plotseries = CreateViewframeScatterplot2(viewframe_x,viewframe_y,parname_x,parname_y,disp_attributes,view_categories,requested_members,h_fig_scatter,aggregation,plotmode,axisextents,rootpath)
...
% property.
            ...
            if strcmp(aggregation,'points')
                ...
                if n_pts>0
                    ...
                    set(h_plotseries(i_hue,i_shade,i_marker),'Tag','scatterplot');
