...
%               {'MWF','EC_AreaFraction'}, ...
%               {'MWF','Axon_AvgOD'}, ...
%               {'MWF','Axon_AvgODThresh'}, ...
%               {'MWF','Axon_AreaFraction'}, ...
%               {'Dlong','MBP_AvgOD'}, ...
%               {'Dlong','MBP_AvgODThresh'}, ...
%               {'Dlong','MBP_AreaFraction'}, ...
%               {'Dlong','EC_AvgOD'}, ...
%               {'Dlong','EC_AvgODThresh'}, ...
%               {'Dlong','EC_AreaFraction'}, ...
%               {'Dlong','Axon_AvgOD'}, ...
%               {'Dlong','Axon_AvgODThresh'}, ...
%               {'Dlong','Axon_AreaFraction'}, ...
%               {'Dtrans','MBP_AvgOD'}, ...
%               {'Dtrans','MBP_AvgODThresh'}, ...
%               {'Dtrans','MBP_AreaFraction'}, ...
%               {'Dtrans','EC_AvgOD'}, ...
%               {'Dtrans','EC_AvgODThresh'}, ...
%               {'Dtrans','EC_AreaFraction'}, ...
%               {'Dtrans','Axon_AvgOD'}, ...
%               {'Dtrans','Axon_AvgODThresh'}, ...
...
%               {'ADC','MBP_AvgOD'}, ...
%               {'ADC','MBP_AvgODThresh'}, ...
%               {'ADC','MBP_AreaFraction'}, ...
%               {'ADC','EC_AvgOD'}, ...
%               {'ADC','EC_AvgODThresh'}, ...
%               {'ADC','EC_AreaFraction'}, ...
%               {'ADC','Axon_AvgOD'}, ...
%               {'ADC','Axon_AvgODThresh'}, ...
%               {'ADC','Axon_AreaFraction'}};
