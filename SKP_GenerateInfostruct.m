...
% MRImap_id{10}.upstreamData{1} = struct('name','T2 distribution w/o SEcorr',...
%                                        'srcfile','CPMG_T2dist',...
%                                        'filetype','.mat',...
%                                        'dirpath','',...
%                                        'im2src_tfm',NaN,...
...
% MRImap_id{10}.upstreamData{2} = struct('name','T2 distribution fixed misfit',...
%                                        'srcfile','CPMG_T2dist_fixedmisfit',...
%                                        'filetype','.mat',...
%                                        'dirpath','',...
%                                        'im2src_tfm',NaN,...
%                                        'options',containers.Map({'varname','T2Times'},...
%                                                                 {'imT2dist_fixedmisfit',T2Times}),...
%                                        'dispFcnName','plot_T2dist');                                   
% MRImap_id{10}.upstreamData{3} = struct('name','signal vs. TE',...
%                                        'srcfile','CPMG_echo_fixedmisfit',...
%                                        'filetype','.mat',...
%                                        'dirpath','',...
%                                        'im2src_tfm',NaN,...
%                                        'options',containers.Map({'varname','TE','varname_pred_decay'},...
%                                                                 {'imEcho_fixedmisfit',TE,'imdecay_pred_fixedmisfit'}),...
%                                        'dispFcnName','plot_CPMG_echo');         
                                   
MRImap_id{10}.filename = 'CPMG_MWF';
MRImap_id{10}.varname = 'imMWF';
MRImap_id{10}.datasetobj_name = 'MWF';
MRImap_id{10}.isDisplayed = 1;
MRImap_id{10}.upstreamData{1} = struct('name','T2 distribution CVNNLS fixed lim',...
                                       'srcfile','CPMG_T2dist',...
                                       'filetype','.mat',...
                                       'dirpath','',...
                                       'im2src_tfm',NaN,...
                                       'options',containers.Map({'varname','T2Times'},...
                                                                {'imT2dist',T2Times}),...
                                       'dispFcnName','plot_T2dist');
MRImap_id{10}.upstreamData{2} = struct('name','signal vs. TE',...
                                       'srcfile','CPMG_echo_CVvarlim',...
                                       'filetype','.mat',...
                                       'dirpath','',...
                                       'im2src_tfm',NaN,...
                                       'options',containers.Map({'varname','TE','varname2'},...
                                                                {'imEcho_CVvarlim',TE,'imdecay_pred_CVvarlim'}),...
                                       'dispFcnName','plot_CPMG_echo');         
...
MRImap_id{12}.filename = 'CPMG_MWF_fixedmisfit';
MRImap_id{12}.varname = 'imMWF_fixedmisfit';
MRImap_id{12}.datasetobj_name = 'MWF_fixedmisfit';
MRImap_id{12}.isDisplayed = 1;
MRImap_id{12}.upstreamData{1} = struct('name','T2 distribution',...
                                       'srcfile','CPMG_T2dist_fixedmisfit',...
                                       'filetype','.mat',...
                                       'dirpath','',...
                                       'im2src_tfm',NaN,...
...
MRImap_id{13}.filename = 'CPMG_GoF_CVvarlim';
MRImap_id{13}.varname = 'imGoF_CVvarlim';
MRImap_id{13}.datasetobj_name = 'CPMG_GoF_CVvarlim';
MRImap_id{13}.isDisplayed = 1;
MRImap_id{13}.upstreamData{1} = struct('name','signal vs. TE',...
                                       'srcfile','CPMG_echo_CVvarlim',...
                                       'filetype','.mat',...
                                       'dirpath','',...
                                       'im2src_tfm',NaN,...
...
MRImap_id{14}.filename = 'CPMG_GoF_fixedmisfit';
MRImap_id{14}.varname = 'imGoF_fixedmisfit';
MRImap_id{14}.datasetobj_name = 'CPMG_GoF_fixedmisfit';
MRImap_id{14}.isDisplayed = 1;
MRImap_id{14}.upstreamData{1} = struct('name','',...
                                       'srcfile','',...
                                       'filetype','',...
                                       'dirpath','',...
                                       'im2src_tfm',NaN,...
...
MRImap_id{15}.filename = 'CPMG_MWF_CVvarlim';
MRImap_id{15}.varname = 'imMWF_CVvarlim';
MRImap_id{15}.datasetobj_name = 'MWF_CVvarlim';
MRImap_id{15}.isDisplayed = 1;
MRImap_id{15}.upstreamData{1} = struct('name','T2 distribution w/o SEcorr',...
                                       'srcfile','CPMG_upstreamData_CVvarlim',...
                                       'filetype','.mat',...
                                       'dirpath','',...
                                       'im2src_tfm',NaN,...
                                       'options',containers.Map({'varname','integlim_varname','T2Times'},...
                                                                {'imT2dist_CVvarlim','integlim_CVvarlim',T2Times}),...
                                       'dispFcnName','plot_T2dist_varlim');
MRImap_id{15}.upstreamData{2} = struct('name','signal vs. TE',...
                                       'srcfile','CPMG_echo_CVvarlim',...
                                       'filetype','.mat',...
                                       'dirpath','',...
                                       'im2src_tfm',NaN,...
...
MRImap_id{16}.filename = 'CPMG_IntegLim_CVvarlim';
MRImap_id{16}.varname = 'imIntegLim_CVvarlim';
MRImap_id{16}.datasetobj_name = 'CPMG_IntegLim_CVvarlim';
MRImap_id{16}.isDisplayed = 1;
MRImap_id{16}.upstreamData{1} = struct('name','',...
                                       'srcfile','',...
                                       'filetype','',...
                                       'dirpath','',...
                                       'im2src_tfm',NaN,...
...
MRImap_id{17}.filename = 'MRI_incl_mask';
MRImap_id{17}.varname = 'MRI_incl_mask';
MRImap_id{17}.datasetobj_name = 'MRI_incl_mask';
MRImap_id{17}.isDisplayed = 1;
MRImap_id{17}.upstreamData{1} = struct('name','',...
                                       'srcfile','',...
                                       'filetype','',...
                                       'dirpath','',...
                                       'im2src_tfm',NaN,...
...
MRImap_id{18}.filename = 'CPMG_MWF_fixedmisfit005';
MRImap_id{18}.varname = 'imMWF_fixedmisfit005';
MRImap_id{18}.datasetobj_name = 'MWF_fixedmisfit005';
MRImap_id{18}.isDisplayed = 1;
MRImap_id{18}.upstreamData{1} = struct('name','T2 distribution',...
                                       'srcfile','CPMG_T2dist_fixedmisfit005',...
                                       'filetype','.mat',...
                                       'dirpath','',...
                                       'im2src_tfm',NaN,...
                                       'options',containers.Map({'varname','T2Times'},...
                                                                {'imT2dist_fixedmisfit005',T2Times}),...
                                       'dispFcnName','plot_T2dist');                                   
                                   

MRImap_id{19}.filename = 'CPMG_GoF_fixedmisfit005';
MRImap_id{19}.varname = 'imGoF_fixedmisfit005';
MRImap_id{19}.datasetobj_name = 'CPMG_GoF_fixedmisfit';
MRImap_id{19}.isDisplayed = 1;
MRImap_id{19}.upstreamData{1} = struct('name','signal vs. TE',...
                                       'srcfile','CPMG_echo_CVvarlim005',...
                                       'filetype','.mat',...
                                       'dirpath','',...
                                       'im2src_tfm',NaN,...
                                       'options',containers.Map({'varname','TE','varname2'},...
...
MRImap_id{20}.filename = 'CPMG_MWF_fixedmisfit_varlim';
MRImap_id{20}.varname = 'imMWF_fixedmisfit_varlim';
MRImap_id{20}.datasetobj_name = 'MWF_fixedmisfit_varlim';
MRImap_id{20}.isDisplayed = 1;
MRImap_id{20}.upstreamData{1} = struct('name','T2 distribution',...
                                       'srcfile','CPMG_T2dist_fixedmisfit_varlim',...
                                       'filetype','.mat',...
                                       'dirpath','',...
                                       'im2src_tfm',NaN,...
                                       'options',containers.Map({'varname','integlim_varname','T2Times'},...
                                                                {'imT2dist_fixedmisfit_varlim','imIntegLim_fixedmisfit_varlim',T2Times}),...
                                       'dispFcnName','plot_T2dist_varlim');                            
                                   

MRImap_id{21}.filename = 'CPMG_GoF_fixedmisfit_varlim';
MRImap_id{21}.varname = 'imGoF_fixedmisfit_varlim';
MRImap_id{21}.datasetobj_name = 'CPMG_GoF_fixedmisfit_varlim';
MRImap_id{21}.isDisplayed = 1;
MRImap_id{21}.upstreamData{1} = struct('name','signal vs. TE',...
                                       'srcfile','CPMG_echo_fixedmisfit_varlim',...
                                       'filetype','.mat',...
                                       'dirpath','',...
                                       'im2src_tfm',NaN,...
                                       'options',containers.Map({'varname','TE','varname2'},...
                                                                {'imEcho_fixedmisfit_varlim',TE,'imdecay_pred_fixedmisfit_varlim'}),...
                                       'dispFcnName','plot_CPMG_echo');         
                                    
                                   
% MRImap_id{13}.filename = 'CPMG_MWF_CVstim';
% MRImap_id{13}.varname = 'imMWF_CVstim';
% MRImap_id{13}.datasetobj_name = 'MWF_CVstim';
% MRImap_id{13}.isDisplayed = 1;
% MRImap_id{13}.upstreamData{1} = struct('name','T2 distribution',...
%                                        'srcfile','CPMG_T2dist_CVstim',...
%                                        'filetype','.mat',...
%                                        'dirpath','',...
%                                        'im2src_tfm',NaN,...
%                                        'options',containers.Map({'varname','T2Times'},...
%                                                                 {'imT2dist_CVstim',T2Times}),...
%                                        'dispFcnName','plot_T2dist');
% 
...
upstream_info{1}.filename = 'CPMG_T2dist';
upstream_info{1}.varname = 'imT2dist';
upstream_info{1}.n_dim = 4;
                                   
% upstream_info{4}.filename = 'CPMG_T2dist_CVstim';
% upstream_info{4}.varname = 'imT2dist_CVstim';
% upstream_info{4}.n_dim = 4;
% 
% upstream_info{5}.filename = 'CPMG_echo_CVstim';
% upstream_info{5}.varname = 'imEcho_CVstim';
% upstream_info{5}.n_dim = 4;

upstream_info{2}.filename = 'CPMG_T2dist_fixedmisfit';
upstream_info{2}.varname = 'imT2dist_fixedmisfit';
upstream_info{2}.n_dim = 4;

upstream_info{3}.filename = 'CPMG_echo_fixedmisfit';
upstream_info{3}.varname = 'imEcho_fixedmisfit';
upstream_info{3}.n_dim = 4;

upstream_info{4}.filename = 'CPMG_T2dist_CVvarlim';
upstream_info{4}.varname = 'imT2dist_CVvarlim';
upstream_info{4}.n_dim = 4;

upstream_info{5}.filename = 'CPMG_echo_CVvarlim';
upstream_info{5}.varname = 'imEcho_CVvarlim';
upstream_info{5}.n_dim = 4;

upstream_info{6}.filename = 'CPMG_echo_CVvarlim';
upstream_info{6}.varname = 'imdecay_pred_CVvarlim';
upstream_info{6}.n_dim = 4;

upstream_info{7}.filename = 'CPMG_T2dist_fixedmisfit005';
upstream_info{7}.varname = 'imT2dist_fixedmisfit005';
upstream_info{7}.n_dim = 4;

upstream_info{8}.filename = 'CPMG_echo_fixedmisfit005';
upstream_info{8}.varname = 'imEcho_fixedmisfit';
upstream_info{8}.n_dim = 4;

upstream_info{9}.filename = 'CPMG_echo_fixedmisfit005';
upstream_info{9}.varname = 'imdecay_pred_fixedmisfit';
upstream_info{9}.n_dim = 4;

upstream_info{10}.filename = 'CPMG_MWF_fixedmisfit005';
upstream_info{10}.varname = 'imMWF_fixedmisfit005';
upstream_info{10}.n_dim = 2;

upstream_info{11}.filename = 'CPMG_GoF_fixedmisfit005';
upstream_info{11}.varname = 'imGoF_fixedmisfit005';
upstream_info{11}.n_dim = 2;

upstream_info{12}.filename = 'CPMG_T2dist_fixedmisfit_varlim';
upstream_info{12}.varname = 'imT2dist_fixedmisfit_varlim';
upstream_info{12}.n_dim = 3;

upstream_info{13}.filename = 'CPMG_echo_fixedmisfit_varlim';
upstream_info{13}.varname = 'imEcho_fixedmisfit_varlim';
upstream_info{13}.n_dim = 3;

upstream_info{14}.filename = 'CPMG_echo_fixedmisfit_varlim';
upstream_info{14}.varname = 'imdecay_pred_fixedmisfit_varlim';
upstream_info{14}.n_dim = 3;

upstream_info{15}.filename = 'CPMG_MWF_fixedmisfit_varlim';
upstream_info{15}.varname = 'imMWF_fixedmisfit_varlim';
upstream_info{15}.n_dim = 2;

upstream_info{16}.filename = 'CPMG_GoF_fixedmisfit_varlim';
upstream_info{16}.varname = 'imGoF_fixedmisfit_varlim';
upstream_info{16}.n_dim = 2;

upstream_info{17}.filename = 'CPMG_IntegLim_fixedmisfit_varlim';
upstream_info{17}.varname = 'imIntegLim_fixedmisfit_varlim';
upstream_info{17}.n_dim = 3;
...
save SKP-upstream_info upstream_info
