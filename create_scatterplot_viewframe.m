...
%   A handle allows the appearance of
%   the lineseries to change, but also encapsulate the data points.
...
% it in the h_plotseries Xdata and Ydata properties The  current lineseries may have one or more dataset are concatenated are concatenated arrays of
% values from the selected parmap_x and parmap_y, respectively
