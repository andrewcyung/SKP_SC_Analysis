    ...
    methods
        ...
        function obj = initDataset(obj)
            ...
            parx_names = {'GFAP_AvgOD','GFAP_AvgODThresh','GFAP_AreaFraction', ...
                ...
                'MBP_AvgOD','MBP_AvgODThresh','MBP_IntegODThresh','MBP_AreaFraction', ...
                'Axon_AvgOD','Axon_AvgODThresh','Axon_IntegODThresh','Axon_AreaFraction', ...
                'GFPSet2_AvgOD','GFPSet2_AvgODThresh','GFPSet2_AreaFraction', ...
                'EC_AvgOD','EC_AvgODThresh','EC_IntegODThresh','EC_AreaFraction', ...
                'FA','ADC','Dlong','Dtrans','TrW', ...
                'CPMG_echo10','CPMG_So','CPMG_flipangle','MWF','CPMG_SNR', ...
                'CPMG_misfit','MWF_CVstim','MWF_fixedmisfit'};
