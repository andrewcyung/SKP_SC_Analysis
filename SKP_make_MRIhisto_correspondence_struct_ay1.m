...
matchkey{1}.excludelist{1} = [22 24 32 33 34 35];
matchkey{1}.excludelist{2} = [22 24 32 33 34 35];
matchkey{1}.excludelist{3} = [22 24 20 32 33 34 35];
...
matchkey{3}.excludelist{3} = [16 18];

matchkey{4}.id = '20';
matchkey{4}.histoextent = [15 20; 20 25; 25 30; 30 35; 35 40];
matchkey{4}.excludelist{1} = [15 16 21 22 30 33];
matchkey{4}.excludelist{2} = [15 19];
matchkey{4}.excludelist{3} = [15 19];

matchkey{5}.id = '36';
matchkey{5}.histoextent = [11 16; 17 23; 24 29; 30 36; 37 42];
matchkey{5}.excludelist{1} = [21 31 36 39 40 41 42];
matchkey{5}.excludelist{2} = [21 39 40 41 42];
...
matchkey{8}.excludelist{1} = [20 21];
matchkey{8}.excludelist{2} = [];
matchkey{8}.excludelist{3} = [];

matchkey{9}.id = '54';
matchkey{9}.histoextent = [8 13; 15 21; 22 27; 28 34; 35 40];
matchkey{9}.excludelist{1} = [8 9 22];
matchkey{9}.excludelist{2} = [8 9 28];
matchkey{9}.excludelist{3} = [8 9 22 28];

matchkey{10}.id = '55';
matchkey{10}.histoextent = [13 18; 20 26; 28 33; 35 41; 43 48];
matchkey{10}.excludelist{1} = [16 18 20 21 22 31 32 35 38 39 40];
matchkey{10}.excludelist{2} = [12 18 20 35];
matchkey{10}.excludelist{3} = [18 20 33 35];
...
matchkey{12}.excludelist{1} = [16 17 26 33 40];
matchkey{12}.excludelist{2} = [17 21 26 33 40];
matchkey{12}.excludelist{3} = [14 16 17 26 33 38 40];
...
matchkey{14}.excludelist{1} = [1 2 3 4 0 6 8 11 14 17 19 21 29];
matchkey{14}.excludelist{2} = [1 2 3 4 6 14 21 29];
matchkey{14}.excludelist{3} = [-1 0 1 2 3 4 6 14 17 21 24 27 29];
