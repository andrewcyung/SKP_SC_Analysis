...
view_categories = {'group','segzone','slice'};
...
requested_members.('segzone') = {'Ventral'};
...
[h_series_x h_series_y]= create_barplot_SKP(vf_x,vf_y,parname_x,parname_y,disp_attributes,h,requested_members,view_categories);
