function ScatterplotClickCallback(h_ax,event,h_scatter_list,h_parMap_list)
...
if strcmp(click_type,'alt')
    ...
    UpdatePointViews(h_scatter_list,h_parMap_list,[],chosen_ptindex,chosen_lineseries);
end